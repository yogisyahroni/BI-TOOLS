...
# ============================================================================
# This module creates the foundational networking layer following AWS
# best-practices: public/private subnet separation, NAT for egress,
...
# ===========================================================================
# NAT Gateway (single AZ for cost optimization, multi-AZ for production)
# ===========================================================================
...
resource "aws_security_group" "ecs" {
  ...
  egress {
    description = "All outbound (DB, Redis, ECR, etc.)"
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
    cidr_blocks = ["0.0.0.0/0"]
