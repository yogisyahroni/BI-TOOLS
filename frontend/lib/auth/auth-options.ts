  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        try {
          const apiUrl = process.env.BACKEND_API_URL || "http://127.0.0.1:8080";
          const loginUrl = `${apiUrl}/api/auth/login`;
          console.log(`[AUTH] Connecting to backend at: ${loginUrl}`);
          ...
          if (data.user) {
            ...
            return {
              ...
              accessToken: data.token, // Capture backend token
            };
          }
