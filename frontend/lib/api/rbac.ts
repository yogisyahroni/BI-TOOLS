 ...
 * @returns Success message
 */
export async function assignRoleToUser(userId: string, roleId: number): Promise<MessageResponse> {
    try {
 ...
 * @returns Success message
 */
export async function removeRoleFromUser(userId: string, roleId: number): Promise<MessageResponse> {
    try {
