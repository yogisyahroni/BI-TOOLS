...
import { useState, useRef, useCallback, _useEffect } from 'react';
import { 
    MessageSquare, 
    X, 
    Edit2, 
                    ...
                    <div className="p-3 border-b bg-muted/50 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium">
                                {annotation.type === 'point' ? 'Point' : 
                                 annotation.type === 'range' ? 'Range' : 'Text'} Annotation
                            </span>
                        </div>
...
export function ChartAnnotations({
    ...
    const annotations = comments.filter(
        (c) => c.annotation && c.annotation.chartId === chartId
    );
                    ...
                    comment.annotation ? (
                        <div key={comment.annotation.id} className="pointer-events-auto">
                            <AnnotationMarker
                                ...
                                onClick={() =>
                                    onSelectAnnotation(
                                        selectedAnnotationId === comment.annotation!.id
                                            ? null
