...
import { _EChartsWrapper } from './echarts-wrapper';
...
const MEKKO_COLORS = ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#06b6d4', '#f97316'];
...
export function MekkoChart({
    ...
    const { _seriesData, segmentNames } = useMemo(() => {
    ...
    return (
        <div className={className}>
            {title && (
                <h3 className="text-sm font-semibold text-center mb-3">{title}</h3>
            )}
