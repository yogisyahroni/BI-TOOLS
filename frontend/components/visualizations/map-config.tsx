  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-xs text-muted-foreground">Supports .geojson and .json files</p>
      </div>
    </div>
  );
}
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">GeoJSON property to join with data</p>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ ...pointConfig, valueColumn: value === "none" ? undefined : value })
            }
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ ...pointConfig, labelColumn: value === "none" ? undefined : value })
            }
          >
        ...
        {pointConfig.heatmap && (
          <>
            <div className="space-y-2">
              <Label htmlFor="heatmap-radius">
                Heatmap Radius: {pointConfig.heatmapRadius || 25}
              </Label>
              <Slider
                id="heatmap-radius"
                min={10}
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Configure map settings and data mappings</CardDescription>
      </CardHeader>
      <CardContent>
