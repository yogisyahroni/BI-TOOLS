  ...
  return (
    <div className="flex flex-col h-full bg-card overflow-hidden">
      ...
      <div className="px-4 pt-4">
        <Tabs
          value={activeSection}
          onValueChange={(v) => setActiveSection(v as "data" | "display")}
        >
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({
                      trendLine: { ...config.trendLine, enabled: checked, type: "linear" },
                    })
                  }
                  className="scale-75"
                />
              ...
              {config.trendLine?.enabled && (
                <div className="pl-6 space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      updateConfig({ trendLine: { ...config.trendLine!, type: val as any } })
                    }
                  >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    updateConfig({
                      referenceLines: [
                        ...current,
                        { id: Date.now().toString(), type: "average", axis: "y" },
                      ],
                    });
                  }}
                >
            ...
            <div className="space-y-3 pt-4 border-t border-border">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({
                      customOptions: { ...config.customOptions, annotationMode: checked },
                    })
                  }
                  className="scale-75"
                />
              ...
              <div className="text-xs text-muted-foreground mb-2">
                {config.customOptions?.annotationMode
                  ? "Click on chart points to add notes"
                  : "Enable to add notes"}
              </div>
              ...
              <div className="space-y-2">
                {config.annotations?.map((ann, idx) => (
                  <div
                    key={ann.id}
                    className="p-2 border rounded-md bg-muted/40 flex justify-between items-start gap-2"
                  >
            ...
            <div className="space-y-3 pt-4 border-t border-border">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ anomaly: { enabled: checked, method: "iqr", sensitivity: 1.5 } })
                  }
                  className="scale-75"
                />
              </div>
              {config.anomaly?.enabled && (
                <div className="pl-6 space-y-2">
                  <Select
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    onValueChange={(val: any) =>
                      updateConfig({ anomaly: { ...config.anomaly!, method: val } })
                    }
                  >
                    <SelectTrigger className="h-7 text-xs">
                      <SelectValue />
            ...
            <div className="space-y-3 pt-4 border-t border-border">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({
                      clustering: { enabled: checked, k: 3, features: config.yAxis || [] },
                    })
                  }
                  className="scale-75"
                />
              ...
              {config.clustering?.enabled && (
                <div className="pl-6 space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        clustering: { ...config.clustering!, k: Number(e.target.value) },
                      })
                    }
                  />
                </div>
