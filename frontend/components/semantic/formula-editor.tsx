...
const AGGREGATION_FUNCTIONS = ["SUM", "AVG", "COUNT", "MIN", "MAX", "MEDIAN", "STDDEV", "VARIANCE"];
    ...
    >
      ...
      <div className="flex items-center gap-2 p-4 border-b border-border/50">
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground">AI-powered metric creation</p>
        </div>
      </div>
      ...
      <div className="flex-1 p-4 space-y-4 overflow-auto">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            <p className="text-[10px] text-muted-foreground">{prompt.length}/500 characters</p>
        ...
        {(generatedFormula || isGenerating || error) && (
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-muted-foreground">Generated Formula</label>

              {/* Validation Status */}
              {generatedFormula && (
                <Badge variant={isValid ? "default" : "destructive"} className="h-5 text-[10px]">
                  {isValid ? (
                    <>
