...
export function AIChatInterface({
  ...
  // Hooks
  const { sendMessage, streamMessage, isSending, isStreaming, response, streamedResponse } =
    useSemanticChat();
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md mb-6">
            Ask me anything about your data. I can help you understand insights, generate queries,
      ...
      <ScrollArea className="flex-1 p-4" ref={scrollRef}>
        <div className="flex flex-col gap-4">
          ...
          {(isSending || isStreaming) && !streamedResponse && (
            <ChatMessage role="user" content={message} timestamp={new Date().toISOString()} />
          )}
