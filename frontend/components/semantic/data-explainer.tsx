    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Get AI-powered insights and explanations</p>
        </div>
      </div>
      ...
      {/* Context Input */}
      <div className="flex flex-col gap-2">
        <label className="text-xs font-medium text-muted-foreground">Context (JSON)</label>
        <Textarea
      ...
      {error && !explanation && (
        <div className="p-4 rounded-lg bg-destructive/10 border border-destructive/20 animate-in fade-in-0">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-xs font-medium text-destructive">Failed to generate explanation</p>
            ...
            {type === "data" && (
              <>
                <Button
                  ...
                  onClick={() => setPrompt("What are the key trends in this sales data?")}
                >
                  Key trends
                </Button>
                <Button
