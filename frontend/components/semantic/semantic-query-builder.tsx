        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Query your data using business terms</p>
            </div>
          </div>
          ...
          {selectedModelId && (
            <>
              ...
              {/* Execute Button */}
              <Button onClick={handleExecute} disabled={executeQuery.isPending} className="w-full">
        ...
        <Card className="bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-lg border-border/50">
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={handleCopySQL} className="h-8">
                {sqlCopied ? (
                  <>
