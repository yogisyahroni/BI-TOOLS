...
export function MainSidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const navItems = [
    { icon: Zap, label: 'Query Editor', href: workspaceId ? `/workspace/${workspaceId}` : '/query' },
    { icon: Database, label: 'Connections', href: '/connections' },
    { icon: PieChart, label: 'Analytics', href: '/analytics' }, // Added Analytics
    ...
    { icon: BarChart3, label: 'Story Builder', href: '/stories' }, // Added Story Builder
  ];
      ...
      >
        ...
        <div className="border-t border-sidebar-border px-3 py-4 space-y-2 bg-sidebar/50">
          ...
          {showDatabases && (
            <div className="space-y-1 animate-in slide-in-from-top-1 duration-200">
              ...
              <Link href="/connections" onClick={() => onClose()} prefetch={false}>
                <Button
                  variant="ghost"
                  size="sm"
        ...
        <div className="border-t border-sidebar-border px-3 py-4 space-y-1 bg-sidebar">
          <div className="flex items-center justify-between gap-1 mb-1">
            <Link href="/settings" onClick={() => onClose()} className="flex-1" prefetch={false}>
              <Button
                variant="ghost"
