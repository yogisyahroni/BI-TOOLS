    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate a secure link to pull this query&apos;s data directly into Excel, Google
            Sheets, or Power BI.
          </DialogDescription>
        </DialogHeader>
                    ...
                    <div key={feed.id} className="border rounded-lg p-3 space-y-3 bg-muted/20">
                      <div className="flex items-center justify-between">
                        <Label className="font-medium text-sm">
                          Live CSV Feed (Excel Compatible)
                        </Label>
                        <Button
                          variant="ghost"
                          size="icon"
                      ...
                      <div className="text-xs text-muted-foreground bg-blue-50/50 dark:bg-blue-900/10 p-2 rounded">
                        ...
                        <ol className="list-decimal pl-4 mt-1 space-y-1">
                          <li>
                            Go to <strong>Data</strong> tab
                          </li>
                          <li>
                            Select <strong>Get Data &gt; From Web</strong>
                          </li>
