...
export function AnalyticsView() {
  ...
  const recentQueries = queries.filter((q) => {
    const daysSince =
      (Date.now() - new Date(q.updated_at || q.created_at).getTime()) / (1000 * 60 * 60 * 24);
    return daysSince <= 7;
  }).length;
      ...
      <div className="flex flex-col gap-8 p-6 max-w-[1600px] mx-auto">
        ...
        <Card className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-muted-foreground max-w-md mb-8">
            Analytics requires data to analyze. Start by creating connections and running queries to
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>Automated discoveries from your data</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
