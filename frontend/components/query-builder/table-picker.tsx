...
export function TablePicker({ connectionId, selectedTable, onTableSelect }: TablePickerProps) {
        ...
        <Select value={selectedTable || undefined} onValueChange={onTableSelect}>
          ...
          <SelectContent className="max-h-[300px]">
            {filteredTables.length === 0 ? (
              <div className="py-6 text-center text-sm text-muted-foreground">No tables found</div>
            ) : (
