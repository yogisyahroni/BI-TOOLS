          ...
          {source.columns.length > 0 ? (
            source.columns.map((col: string, idx: number) => (
              ...
              >
                ...
                />
                <label htmlFor={`${source.id}-${col}`} className="flex-1 cursor-pointer">
                  {col}
                </label>
              </div>
            ))
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-b bg-background flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={() => setShowSourceDialog(true)}>
          ...
          <Panel position="top-left">
            <Card className="p-3 shadow-lg">
              <div className="text-xs space-y-1">
                ...
                <div>
                  <strong>Joins:</strong> {joins.length}
                </div>
              </div>
            </Card>
          </Panel>
        ...
        <div className="h-[300px] border-t bg-muted/30">
          <div className="p-4">
            ...
            <ScrollArea className="h-[200px]">
              ...
              <div className="text-sm text-muted-foreground">Preview table implementation...</div>
            </ScrollArea>
          </div>
        </div>
      )}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Select a data source and table to add to your blend</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: JoinType) => setEditedJoin({ ...editedJoin, type: value })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground mb-2">TODO: Add condition builder UI</div>
          </div>
        </div>
        <DialogFooter>
