...
export function GlobalFilters({
  ...
  if (collapsed) {
    return (
      ...
      >
        <Button variant="outline" size="sm" onClick={() => setCollapsed(false)} className="gap-2">
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={() => setCollapsed(true)} className="h-8">
            <X className="h-4 w-4" />
          </Button>
        </div>
      </div>
