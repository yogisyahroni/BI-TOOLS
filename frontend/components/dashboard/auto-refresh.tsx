...
export function AutoRefresh({
  ...
  useInterval(executeRefresh, config.enabled ? config.interval * 1000 : null);
    ...
    <div className={cn("flex items-center gap-3 p-3 bg-muted/30 border rounded-lg", className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <span className="text-xs text-muted-foreground">Last: {lastRefreshText}</span>
        </div>
      </div>
      ...
      <PopoverContent className="w-80" align="end">
        <div className="grid gap-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Configure refresh behavior</p>
          </div>
          ...
          <div className="grid gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => onUpdateConfig({ showCountdown: checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => onUpdateConfig({ showNotifications: checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => onUpdateConfig({ pauseOnUserActivity: checked })}
              />
            </div>
          </div>
        </div>
