    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Choose a data source for your new widget</DialogDescription>
        </DialogHeader>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
          {/* Option 1: Existing Query */}
          <Card
            className="p-4 cursor-pointer hover:border-primary border-2 border-transparent hover:bg-muted/5 transition-all space-y-4"
