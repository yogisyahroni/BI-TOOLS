            ...
            <div className="flex items-center justify-between p-4 border-b bg-muted/20">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        className={cn("gap-1 text-xs", enableReasoning && "bg-primary/10 text-primary hover:bg-primary/20")}
                ...
                <div className="space-y-6">
                    {chatHistory.length === 0 && (
                        <div className="text-center text-muted-foreground mt-20">
                            ...
                            <p className="text-xs mt-1">Try asking for SQL queries, explanations, or data insights.</p>
                        </div>
                    )}
            ...
            <div className="p-4 border-t bg-background">
                ...
                <div className="flex justify-between items-center mt-2 text-xs text-muted-foreground">
                    <div className="flex gap-2">
                        <Badge variant="outline" className="text-[10px] font-normal">GPT-4 Supported</Badge>
                        <Badge variant="outline" className="text-[10px] font-normal">Streaming Enabled</Badge>
                    </div>
                    ...
                    {steps.map((step) => (
                        <div key={step.step} className="text-xs">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="font-mono text-[10px] bg-muted px-1.5 py-0.5 rounded text-foreground">Step {step.step}</span>
