  ...
  const quickActions = [
    {
      ...
      action: () => setPrompt("Explain what this SQL query does:\n\n" + (currentSQL || "")),
    },
    {
      label: "Optimize query",
      action: () =>
        setPrompt("Optimize this SQL query for better performance:\n\n" + (currentSQL || "")),
    },
    {
      label: "Find errors",
      action: () => setPrompt("Check this SQL for any errors or issues:\n\n" + (currentSQL || "")),
    },
    {
      label: "Add filters",
      action: () => setPrompt("Add date range filters to this query:\n\n" + (currentSQL || "")),
    },
  ];
  ...
  return (
    <>
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetContent
          side="right"
          className={cn("w-full sm:max-w-xl p-0 flex flex-col", isExpanded && "sm:max-w-2xl")}
        >
          {/* Header */}
              ...
              {chatHistory.length === 0 && (
                <div className="text-center text-muted-foreground py-10">
                  ...
                  <p className="text-xs mb-6">
                    Ask me to write SQL, explain queries, or analyze your data
                  </p>
