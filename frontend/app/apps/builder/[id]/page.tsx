        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground flex items-center gap-2">
              ...
              {app.isPublished ? (
                <span className="text-green-600 font-medium px-1.5 py-0.5 bg-green-100 rounded-full text-[10px]">
                  Published
                </span>
              ) : (
                <span className="text-slate-500 font-medium px-1.5 py-0.5 bg-slate-100 rounded-full text-[10px]">
                  Draft
                </span>
              )}
            </div>
