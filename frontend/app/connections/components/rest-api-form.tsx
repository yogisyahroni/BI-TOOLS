        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.method}
                onValueChange={(val) => updateConfig("method", val as HTTPMethod)}
              >
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(val) => updateConfig("authType", val as AuthType)}
            >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(val) => onUpdate("location", val)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(val) => onUpdate("grant_type", val)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
