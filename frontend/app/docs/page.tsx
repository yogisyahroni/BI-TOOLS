    ...
    <div className="space-y-10">
      <div className="space-y-4">
        ...
        <p className="text-xl text-muted-foreground">
          Welcome to the InsightEngine documentation. Learn how to build dashboards, connect data
          sources, and manage your analytics platform.
        </p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-lg border bg-card p-6 shadow-sm">
          ...
          <p className="mb-4 text-muted-foreground">
            Detailed guides on how to use InsightEngine&apos;s features, including dashboards,
