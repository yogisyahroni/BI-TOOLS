    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      {data?.systemHealth && data.systemHealth.status !== "healthy" && (
        <Card className="border-destructive">
          <CardHeader>
            ...
            <CardDescription>Some system components require attention</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.orgStats?.totalOrganizations || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.userStats?.totalUsers || 0}</div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.userStats?.newThisMonth || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            {data?.systemHealth ? (
              ...
              <p className="text-sm text-muted-foreground">System Data Unavailable</p>
            )}
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage organizations and workspaces</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
              ...
              {data?.systemHealth && (
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={getSystemStatusVariant(data.systemHealth.status)}>
            ...
            <Button asChild className="mt-4 w-full">
              <Link href="/admin/system">View System Health</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      {data?.userStats && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Breakdown of user status and verification</CardDescription>
          </CardHeader>
          <CardContent>
