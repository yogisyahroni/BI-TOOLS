...
[x] **Task 123: Semantic Model Builder**

- [x] Backend: Create `SemanticModel` struct (Go) <!-- id: 1230 -->
- [x] Backend: Implement `SemanticLayerHandler` (CRUD) <!-- id: 1231 -->
- [x] Frontend: Create `SemanticModel` List View <!-- id: 1232 -->
- [x] Frontend: Create Model Designer (Dimensions/Metrics) <!-- id: 1233 -->
- [/] Frontend: Implement "Generate Metric with AI" <!-- id: 1234 -->
